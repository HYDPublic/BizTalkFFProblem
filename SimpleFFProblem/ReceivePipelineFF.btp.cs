namespace SimpleFFProblem
{
    ...
    public sealed class ReceivePipelineFF : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"       <Value xsi:type=\"xsd:string\">SimpleFFProblem.SapEmployee_FF</Value>            </Property>   "+
...
"-4536-83fa-4a5040674ad6\" />      <Components />    </Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "0e72acca-3b3a-4e7f-a64a-478c60d22dd4";
        
        public ReceivePipelineFF()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">SimpleFFProblem.SapEmplo"+
"yee_FF</Value>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"PreserveHead"+
